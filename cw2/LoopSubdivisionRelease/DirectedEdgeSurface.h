...
class DirectedEdgeSurface
    ...
    void updateFirstDiredges();

    // update the normals for the updated original vertices
    void updateOldNormals(int originalVertNum);

    // update otherHalf edges
    void updateOtherhalves();
